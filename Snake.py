...
intro = pygame.image.load("Screen/snake_main.jpg")
outro = pygame.image.load("Screen/game_over.png")
...
#Game Title
pygame.display.set_caption("Snake By Shivansh")
...
#GameOverScreen
           ...
           text_screen("Score: " + str(score ), snakegreen, 385, 325)
           for event in pygame.event.get():
               if event.type == pygame.QUIT:
                   exit_game = True
               if event.type == pygame.KEYDOWN:
           ...
           text_screen("Score: " + str(score) + "  Highscore: "+str(highscore),  snakegreen, 1,1)
           ...
           if head in snk_list[:-1]:
               game_over = True
               pygame.mixer.music.load('music/coffin.mp3')
               pygame.mixer.music.play(100)
               pygame.mixer.music.set_volume(.6)
           if snake_x<0 or snake_x>screen_width or snake_y<0 or snake_y>screen_height:
               ...
               pygame.mixer.music.play(100)
               pygame.mixer.music.set_volume(.6)
           plot_snake(gameWindow, snakegreen, snk_list, snake_size)
       pygame.display.update()
       clock.tick(fps)
   pygame.quit()
   quit()
